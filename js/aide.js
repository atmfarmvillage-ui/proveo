...
const AIDE_FICHES = [
  {
    ...
    etapes: [
      ...
      "Vérifier que la <b>date</b> est bien celle du jour, et choisir <b>sa caisse</b> dans la liste.",
      "Compter physiquement l'argent du tiroir — billets et pièces.",
      "Saisir le montant compté dans <b>Cash compté</b>. L'écart s'affiche aussitôt.",
      "Si l'écart n'est pas à zéro, écrire dans la <b>note</b> ce qu'on croit être la cause, même si on n'est pas sûr.",
      "Cliquer sur <b>Enregistrer la clôture</b>.",
    ],

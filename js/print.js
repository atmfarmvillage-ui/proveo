...
function printFicheTechnique(formule){
  ...
  const html='<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Etiquettes -- '+formule.nom+'</title>'
    ...
    +'.ident{padding:.8mm 1.5mm .5mm;text-align:center;border-bottom:1px solid #000}'
    ...
    +'.bandeau{text-align:center;font-size:10px;font-weight:bold;padding:.45mm 0;border-bottom:1px solid #000}'
    +'.nt{width:100%;border-collapse:collapse;flex:1;font-size:7.6px}'
    +'.nt th{font-size:7.6px;font-weight:bold;padding:.35mm 1.5mm;text-align:left;border-bottom:1px solid #000;line-height:1.12}'
    +'.nt th:last-child{text-align:right}'
    +'.nt td{padding:.28mm 1.5mm;border-bottom:.4px solid #999;line-height:1.12}'
    ...
    +'.lieu{font-size:5px;text-align:center;color:#333;padding:.2mm 0;line-height:1.1}'
